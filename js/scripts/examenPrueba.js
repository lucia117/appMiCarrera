    ...
    //variables globales
        ...
        var mostrarMateriasParaInscribir = function (datos) {
            ...
            if (datos.mensajeValidacion === 'null') {
                ...
                var fecha = invertitFecha(datos.fechaHora[0].fecha) ;
                 
                $('#modTurno').text(datos.fechaExamen.nombre);
                $('#modFecha').text(fecha);
                $('#modHora').text(datos.fechaHora[0].hora);
        ...
        return {
            ...
            examenOk: function (respuesta) {
                ...
                if (respuesta.estado) {
                    ...
                    swal("Inscripto con éxito, sujeto a abono de Permiso de Examen en Secretaría del Colegio");
